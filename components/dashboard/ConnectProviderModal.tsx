...
export function ConnectProviderModal({ open, onOpenChange }: ConnectProviderModalProps) {
  const providers = [
    { id: 'youtube', name: 'YouTube', icon: Youtube, color: 'hover:bg-red-50 hover:text-red-600 hover:border-red-200' },
    { id: 'x', name: 'X (Twitter)', icon: Twitter, color: 'hover:bg-slate-50 hover:text-slate-900 hover:border-slate-200' },
  ]
